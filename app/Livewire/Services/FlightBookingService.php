...
class FlightBookingService extends Component
{
    ...
    public function storeFlightBooking()
    {
        $this->validate([
            ...
            // 'comments' => 'required',
            'departureHour' => 'required|integer|between:00,24',
            'departureMinute' => 'required|integer|between:00,59',
            'departure_eta_date' => 'required',
            'departureETAHour' => 'required|integer|between:00,24',
            'departureETAMinute' => 'required|integer|between:00,59',
            ...
            'departureETAHour.integer' => 'Departure ETA Hour should be a number',
            ...
            'departureETAMinute.integer' => 'Departure ETA Minute should be a number',
