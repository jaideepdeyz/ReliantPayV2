...
class AmtrackBookingService extends Component
{
    ...
    public function storeAmtrakBooking()
    {
        $this->validate([
            ...
            'departureETAHour.integer' => 'Departure ETA Hour must be numeric',
            ...
            'departureETAMinute.integer' => 'Departure ETA Minute must be numeric',
