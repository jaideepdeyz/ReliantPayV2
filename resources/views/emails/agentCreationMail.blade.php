...
<title>ReliantPay - New Agent Creation Confirmation</title>
                    ...
                    <table width="100%" cellpadding="0" cellspacing="0"
                        ...
                        <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                            <td class="content-block"
                                ...
                                <p>We're thrilled to inform you that you have been registrered as an Agent by <b>{{$mailData['organization_name']}} Merchant</b></p>

                                <p>Welcome to the ReliantPay family.</p>

                                <p>Here are some key details to get you started:</p>

                                <p><b>* Login Credentials: *</b> Your registered email is {{$mailData['email'] }}. Please use the dafault password <b>Agent@123#</b> to login to ReliantPay at <a href="https://reliant.yellowberry.in/login">https://reliant.yellowberry.in/login</a></p>

                                <p><b>* Security Reminder: *</b>
                                    <ol>
                                        <li>Mandatory <b>Password Change</b> is required and will be automatically enforced.</li>
                                        <li>Ensure the security of your account by keeping your login details confidential.</li>
                                        <li>Report any suspicious activity in your account immediately to your manager(s).</li>
                                    </ol>
                                </p>

                                <p><b>* Need Help?: *</b> If you have any questions or require assistance, please don't hesitate to contact our support team at <a href="mailto:support@reliantpay.com">support@reliantpay.com</a></p>
