...
<head>
    ...
    <title>STATE HORTICULTURE SCHOLARSHIP 2023</title>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div>
                    ...
                    <p>You have applied for the <b>State Horticulture Scholarship {{ $app->year }} under
                            {{ $app->category }} category</b> with Application No.: <b>{{ $app->transaction_id }}</b>.
                        The Department of Horticulture, Government of Nagaland, will review your application after the
                            ...
                            <td colspan="1">
                                <img src="data:image/png;base64, {!! base64_encode(
                                    QrCode::format('svg')->size(110)->generate(
                                            'STATE HORTICULTURE SCHOLARSHIP 2023 - @https://scholarship.nagaland.gov.in - Applicant Name: ' .
