...
<head>
    ...
    <title>STATE MEDICAL SCHOLARSHIP 2023</title>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div>
                    ...
                    <p>You have applied for the <b>State Medical Scholarship {{ $app->year }} under
                            {{ $app->category }} category</b> with Application No.: <b>{{ $app->transaction_id }}</b>.
                        The Department of Health & Family Welfare, Government of Nagaland, will review your application after the
                    ...
                    <table class="table table-sm table-borderless">
                        ...
                        <tr>
                            ...
                            <td><b>Guardians Relationship:</b> {{ $app->user->profile->guardians_relationship }}
                            </td>
                        ...
                        <tr>
                            <td><b>Course:</b> {{ $app->course->name }}</td>
                        ...
                        <tr>
                            <td><b>Quota:</b> {{ $data->quota }} Quota</td>
                            ...
                            <td><b>Session Commencement Date:</b> {{ Carbon\Carbon::parse($data->session_commencement_date)->format('d-m-Y') }}</td>
                        </tr>
                        <tr>
                            <td colspan="3">
                            ...
                            <td colspan="1">
                                <img src="data:image/png;base64, {!! base64_encode(
                                    QrCode::format('svg')->size(110)->generate(
                                            'STATE MEDICAL SCHOLARSHIP 2023 - @https://scholarship.nagaland.gov.in - Applicant Name: ' .
