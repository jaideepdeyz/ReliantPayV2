...
<head>
    ...
    <title>DISABILITY SCHOLARSHIP 2023</title>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div>
                    ...
                    <p>You have applied for the <b>Scholarship for Persons with Disabilities {{ $app->year }} under
                            {{ $app->category }} category</b>
                        with Application No.: <b>{{ $app->transaction_id }}</b>. The Department of Social Welfare,
                        Government of Nagaland, will review your application after the announced deadline.</p>
                    ...
                    <table class="table table-sm table-borderless">
                        ...
                        <tr>
                            <td colspan="2"><b>Course/Class:</b> {{ $app->course->name }}</td>
                            <td><b>Course Code:</b> {{ $app->course->course_code }}</td>
                            <td><b>UDID No.:</b> {{ $app->disabilityScho->udid_no }}</td>
                        </tr>
                        <tr>
                            <td colspan="3">
                            ...
                            <td colspan="1">
                                <img src="data:image/png;base64, {!! base64_encode(
                                    QrCode::format('svg')->size(110)->generate(
                                            'Scholarship for Persons with Disabilities 2023 - @https://scholarship.nagaland.gov.in - Applicant Name: ' .
