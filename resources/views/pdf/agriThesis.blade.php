...
<head>
    ...
    <title>STATE AGRICULTURE THESIS GRANT 2023</title>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div>
                    ...
                    <p>You have applied for the <b>State Agriculture Thesis Grant {{ $app->year }} under
                            {{ $app->category }} category</b> with Application No.: <b>{{ $app->transaction_id }}</b>.
                        The Department of Agriculture, Government of Nagaland, will review your application after the
                    ...
                    <table class="table table-sm table-borderless">
                        ...
                        <tr>
                            ...
                            <td><b>Date of Passing (M.Sc.):</b> {{ $data->passing_date }}</td>
                        </tr>
                        <tr>
                            <td colspan="3">
                            ...
                            <td colspan="1">
                                <img src="data:image/png;base64, {!! base64_encode(
                                    QrCode::format('svg')->size(110)->generate(
                                            'STATE AGRICULTURE THESIS GRANT 2023 - @https://scholarship.nagaland.gov.in - Applicant Name: ' .
