...
<head>
    ...
    <title>MERIT SCHOLARSHIP 2023</title>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div>
                    ...
                    <p>You have applied for the <b>State Merit Scholarship {{ $app->year }} under
                            ...
                            <td colspan="1">
                                <img src="data:image/png;base64, {!! base64_encode(
                                    QrCode::format('svg')->size(110)->generate(
                                            'MERIT SCHOLARSHIP 2023 - @https://scholarship.nagaland.gov.in - Applicant Name: ' .
