                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="avatar-lg rounded-circle bg-success border-success border shadow">
                                <i class="bi bi-person-badge font-22 avatar-title text-white"></i>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="text-end">
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="avatar-lg rounded-circle bg-info border-info border shadow">
                                <i class="bi bi-people-fill font-22 avatar-title text-white"></i>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="text-end">
                                <h3 class="text-dark mt-1"><span data-plugin="counterup">0.58</span>%</h3>
                                <p class="text-muted mb-1 text-truncate">Dealers</p>
                            </div>
                        </div>
                    </div> <!-- end row-->
                </div>
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="avatar-lg rounded-circle bg-warning border-warning border shadow">
                                <i class="bi bi-person-lines-fill font-22 avatar-title text-white"></i>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="text-end">
                                <h3 class="text-dark mt-1"><span data-plugin="counterup">78.41</span>k</h3>
                                <p class="text-muted mb-1 text-truncate">Pending Dealer Registration</p>
                            </div>
                        </div>
                    </div> <!-- end row-->
                </div>
                            ...
                            <table class="table table-borderless table-hover table-nowrap table-centered m-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$authorization->agent->organization->business_name}}</td>
                                        <td>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <span
                                                class="badge bg-soft-success text-dark">{{$booking->app_status}}</span>
                                            @break
                                            @default
                                            <span
                                                class="badge bg-soft-warning text-warning">{{$booking->app_status}}</span>
