                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-12">
                                    <label for="business_address" class="form-label">Address <span
                                            class="text-danger"><sup>*</sup></span></label>
                                ...
                                <div class="mb-3 col-md-4">
                                    <label for="business_website" class="form-label">Website <span
                                            class="text-danger"><sup>*</sup></span></label>
                                    <input type="text"
                                ...
                                <div class="mb-3 col-md-4">
                                    <label for="business_email" class="form-label">E-Mail <span
                                            class="text-danger"><sup>*</sup></span></label>
                                    <input type="text"
                                ...
                                <div class="mb-3 col-md-4">
                                    <label for="business_phone" class="form-label">Phone <span
                                            class="text-danger"><sup>*</sup></span></label>
                                    <input type="text"
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-12 action-buttons d-flex justify-content-between">
                                    <button type="button" class="btn w-sm btn-secondary waves-effect waves-light"
                ...
                @if ($currentStep == 3)
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="mb-3 col-md-6">
                                    <label for="business_bank_account_name" class="form-label">Bank Account Name <span
                                            class="text-danger"><sup>*</sup></span></label>
                                ...
                                <div class="mb-3 col-md-6">
                                    <label for="business_bank_name" class="form-label">Bank Name <span
                                            class="text-danger"><sup>*</sup></span></label>
                                ...
                                <div class="mb-3 col-md-6">
                                    <label for="business_bank_address" class="form-label">Bank Address <span
                                            class="text-danger"><sup>*</sup></span></label>
                                    <input type="text" class="form-control" placeholder="Enter Bank Address"
                                ...
                                <div class="mb-3 col-md-6">
                                    <label for="business_bank_IBAN" class="form-label">Bank IBAN <span
                                            class="text-danger"><sup>*</sup></span></label>
                                ...
                                <div class="mb-3 col-md-6">
                                    <label for="business_bank_IFSC" class="form-label">Bank IFSC <span
                                            class="text-danger"><sup>*</sup></span></label>
                                ...
                                <div class="mb-3 col-md-6">
                                    <label for="business_bank_SWIFT_code" class="form-label">Bank SWIFT Code <span
                                            class="text-danger"><sup>*</sup></span></label>
                                ...
                                <div class="mb-3 col-md-6">
                                    <label for="business_bank_routing_code" class="form-label">Bank Routing Code <span
                                            class="text-danger"><sup>*</sup></span></label>
                ...
                @if ($currentStep == 4)
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="mb-3 bg-soft-info px-2 py-1">
                                <h5>All Documents to be uploaded in PDF format only with a maximum file size of 5 MB
                                    per document.</h5>
                            </div>
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-6" style="position:relative" x-data="{ uploading: false, progress: 0 }"
                                    ...
                                    x-on:livewire-upload-error="uploading = false"
                                    x-on:livewire-upload-progress="progress = $event.detail.progress">
                                    <label for="business_scan_PAN" class="form-label">Scanned PAN <span
                                            class="text-danger"><sup>*</sup></span></label>
                                ...
                                <div class="mb-3 col-md-6" style="position:relative" x-data="{ uploading: false, progress: 0 }"
                                    ...
                                    x-on:livewire-upload-error="uploading = false"
                                    x-on:livewire-upload-progress="progress = $event.detail.progress">
                                    <label for="business_premises_external_pictures" class="form-label">Business
                                        Premises
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-12 action-buttons d-flex justify-content-between">
                                    <button type="button" class="btn w-sm btn-secondary waves-effect waves-light"
                                        wire:click="decreaseStep()">Previous</button>
                                    <button type="submit"
                                        class="btn w-sm btn-success waves-effect waves-light">Submit</button>
                                </div>
                            </div>
                        </div>
                    </div>
