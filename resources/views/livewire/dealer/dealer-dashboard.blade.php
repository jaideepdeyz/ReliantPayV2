    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                ...
                <p><b>Need assistance?</b> Reach out to our support team anytime on <b>support@reliantpay.com</b>,
                    kindly include your registered <b>EMAIL and MOBILE</b> Number in your support request for us to
                    address your concerns effectively.</p></b>
            </div>
        </div>
    </div>
                        ...
                        <table class="table table-hover table-striped table-borderless wrap table-fixed">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('dealerServicesCompliances', [ 'orgID'=> Auth::User()->organization_id, 'viewOnly' => 'view']) }}"
                                            class="btn btn-primary btn-sm">View</a>
                                        @if(Auth::User()->organization->status == StatusEnum::REJECTED->value)
                                        <a href="{{ route('dealerServicesCompliances', Auth::User()->organization_id) }}"
                                            class="btn btn-primary btn-sm">Edit</a>
                                        @endif
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('dealerBankingDetails', [ 'orgID'=> Auth::User()->organization_id, 'viewOnly' => 'view']) }}"
                                            class="btn btn-primary btn-sm">View</a>
                                        @if(Auth::User()->organization->status == StatusEnum::REJECTED->value)
                                        <a href="{{ route('dealerBankingDetails', Auth::User()->organization_id) }}"
                                            class="btn btn-primary btn-sm">Edit</a>
                                        @endif
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('dealerDocs', [ 'orgID'=> Auth::User()->organization_id, 'viewOnly' => 'view']) }}"
                                            class="btn btn-primary btn-sm">View</a>
                                        @if(Auth::User()->organization->status == StatusEnum::REJECTED->value)
                                        <a href="{{ route('dealerDocs', Auth::User()->organization_id) }}"
                                            class="btn btn-primary btn-sm">Edit</a>
                                        @endif
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('confirmation', [ 'orgID'=> Auth::User()->organization_id, 'viewOnly' => 'view'] )}}"
                                            class="btn btn-primary btn-sm">View</a>
                                        @if(Auth::User()->organization->status == StatusEnum::REJECTED->value)
                                        <a href="{{ route('confirmation', Auth::User()->organization_id) }}"
                                            class="btn btn-primary btn-sm">Edit</a>
                                        @endif
                                    </td>
                                </tr>
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <div class="text-end">
                            ...
                            <p class="text-muted mb-1 text-truncate"><a href="{{ route('manageCustomers') }}">Completed
                                    Bookings</a></p>
                        </div>
                    </div>
                </div> <!-- end row-->
                ...
                <div class="card-body pb-2">
                    <div class="float-end d-none d-md-inline-block">
                        <div class="btn-group mb-2">
                            <button type="button" class="btn btn-xs btn-light mr-1" wire:click="updateChart('10')">Last
                                10 Days</button>
                            <button type="button" class="btn btn-xs btn-light  mr-1" wire:click="updateChart('30')">Last
                                30 days</button>
                            <button type="button" class="btn btn-xs btn-light  mr-1" wire:click="updateChart('60')">Last
                                60 days</button>
                    ...
                    <div dir="ltr" x-data="{ chartData: {} }" x-init="
