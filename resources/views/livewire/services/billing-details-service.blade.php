                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-md-4">
                                <label for="cc_type" class="form-label">Credit Card Type? <span
                            ...
                            <div class="mb-3 col-md-3">
                                <div class="dropdownList">
                                    ...
                                    {{-- <input type="text"
                                        ...
                                        placeholder="Search Cities .." wire:model.live="cityQuery" required> --}}
                                    <input type="text"
                                        class="form-input form-control @error('cityQuery') is-invalid @enderror"
                            ...
                            <div class="mb-3 col-md-3">
                                <div class="dropdownList">
                                    ...
                                    {{-- <input type="text"
                                        ...
                                        placeholder="Search States .." wire:model.live="stateQuery" required> --}}
                                    <input type="text"
                                        class="form-input form-control @error('stateQuery') is-invalid @enderror"
                            ...
                            <div class="mb-3 col-md-6">
                                <label for="cc_email" class="form-label">Card Holder's Email <span
                                        class="text-danger"><sup>*</sup></span></label>
                                <input type="email" class="form-control @error('cc_email') is-invalid @enderror"
                                    wire:model="cc_email">
                                @error('cc_email')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="mb-3 col-md-4">
                                <label for="bookedThroughReservationAssistance" class="form-label">Ticket booked through
                                    Reservation Assistance ?:</label>
                                <select
