 <!-- ========== Menu ========== -->
            <div class="app-menu">  
               ...
               <div class="text-center p-3">
                    <a href="#">
                        <span >
                            <img src="{{ asset ('auth/images/adminlogo/admin-logo-dark.png') }}" alt="Reliant Pay">
                        </span>
                    </a>
                </div>
                ...
                <div class="scrollbar">
                    ...
                    <div class="user-box text-center">
                        ...
                        <img src="{{ asset ('auth/images/users/user-1.jpg') }} alt="user-img" title="Mat Helme" class="rounded-circle avatar-md">
                    ...
                    <ul class="menu">
                        ...
                        <li class="menu-item">
                            <a href="#menuStudentSubmissions" data-bs-toggle="collapse" class="menu-link">
                                ...
                                <span class="menu-text"> Student Submissions </span>
                            ...
                            <div class="collapse" id="menuStudentSubmissions">
                                ...
                                <li class="menu-item">
                                    <a href="{{ route('managestudentoba')}}" class="menu-link">
                                ...
                                <li class="menu-item">
                                    <a href="{{ route('managestudentvma')}}" class="menu-link">
                                ...
                                <li class="menu-item">
                                    <a href="{{ route('managestudentsadhana')}}" class="menu-link">
                         ...
                         <li class="menu-item">
                            ...
                            <div class="collapse" id="menuAdministration">
                                ...
                                <li class="menu-item">
                                    <a href="{{ route('managecourses') }}" class="menu-link">
                                ...
                                <li class="menu-item">
                                    <a href="{{ route('managebatches') }}" class="menu-link">
                         ...
                         <li class="menu-item">
                            ...
                            <div class="collapse" id="menuPayments">
                                ...
                                <li class="menu-item">
                                    <a href="manageobaquestions" class="menu-link">
                        ...
                        <li class="menu-item">
                            ...
                            <div class="collapse" id="menuSettings">
                                ...
                                <li class="menu-item">
                                    <a href="{{ route('manageobaquestions') }}" class="menu-link">
                                ...
                                <li class="menu-item">
                                    <a href="{{ route('managecountries') }}" class="menu-link">
                                ...
                                <li class="menu-item">
                                    <a href="{{ route('manageindianstates') }}" class="menu-link">
                                ...
                                <li class="menu-item">
                                    <a href="{{ route('managecoursedeliverymodes') }}" class="menu-link">
                                ...
                                <li class="menu-item">
                                    <a href="{{ route('managecoursecategories') }}" class="menu-link">
                        ...
                        <li class="menu-item">
                            <a href="#menuLayouts" data-bs-toggle="collapse" class="menu-link">
                                <span class="menu-icon"><i class="mdi mdi-cellphone-link"></i></span>
