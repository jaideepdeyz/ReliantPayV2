                                ...
                                <div class="widget-rounded-circle card">
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                <div class="text-end">
                                                    <h3 class="text-dark mt-1"><i class="bi bi-currency-rupee"></i><span data-plugin="counterup">58,947</span></h3>
                                ...
                                <div class="widget-rounded-circle card">
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                <div class="text-end">
                                                    <h3 class="text-dark mt-1"><span data-plugin="counterup">54</span></h3>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="widget-chart text-center" dir="ltr">
                                            ...
                                            <h2><i class="bi bi-currency-rupee"></i><span data-plugin="counterup">58,947</span></h2>

                                            <p class="text-muted w-75 mx-auto sp-line-2">Mayapur Institutes Revenues for this month is up by 27% compared to last month</p>

                                            <div class="row mt-3">
                                                <div class="col-4">
                                                    <p class="text-muted font-15 mb-1 text-truncate">Target</p>
                                                    <h4>
                                                        <i class="fe-arrow-down text-danger me-1"></i>
                                                ...
                                                <div class="col-4">
                                                    ...
                                                    <h4>
                                                        <i class="fe-arrow-up text-success me-1"></i>
                                                        <i class="bi bi-currency-rupee">
                                                            1.4k
                                                        </i>
                                                    </h4>
                            ...
                            <div class="col-lg-8">
                                <div class="card">
                                    <div class="card-body pb-2">
                                        ...
                                        <h4 class="header-title mb-3">Course Enrolment Analytics</h4>
