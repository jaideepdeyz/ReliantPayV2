...
<head>
    ...
    <link rel="icon" type="image/png" sizes="192x192"  href="{{ asset('website/images/favicon/android-icon-192x192.png') }}">
...
<header class="header">
    <div class="container">
        <nav class="navbar position-relative navbar-expand-lg navbar-light">
            <a class="navbar-brand" href="/"><figure class="mb-0"><img src="{{ asset('website/images/banner-logo.png') }}" alt="" class="img-fluid"></figure></a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link login" href="{{ route('login') }}"><i class="fa-solid fa-user-lock"></i>Sign in</a>
                    </li>
                </ul>
            </div>
        </nav>
                ...
                <ul class="mb-0 list-unstyled">
                    <li>
                        <figure class="mb-0 partner1">
                            <img class="img-fluid" src="{{ asset('website/images/partner-logo-1.png') }}" alt="">
                        </figure>
                    </li>
                    <li>
                        <figure class="mb-0 partner1 partner2">
                            <img class="img-fluid" src="{{ asset('website/images/partner-logo-2.png') }}" alt="">
                        </figure>
                    </li>
                    <li class="img-mb">
                        <figure class="mb-0 partner1 partner3">
                            <img class="img-fluid" src="{{ asset('website/images/partner-logo-3.png') }}" alt="">
                        </figure>
                    </li>
                    <li>
                        <figure class="mb-0 partner1 partner4">
                            <img class="img-fluid" src="{{ asset('website/images/partner-logo-4.png') }}" alt="">
                        </figure>
                    </li>
                    <li>
                        <figure class="mb-0 partner1 partner5">
                            <img class="img-fluid" src="{{ asset('website/images/partner-logo-5.png') }}" alt="">
                        </figure>
                    </li>
                    <li>
                        <figure class="mb-0 partner1 partner5">
                            <img class="img-fluid" src="{{ asset('website/images/partner-logo-6.png') }}" alt="">
                        </figure>
                    </li>
                </ul>
            </div>
                ...
                <div class="col-lg-4 col-md-5 col-sm-6 col-12">
                    <a href="./index.html">
                        <figure class="footer-logo">
                            <img src="{{ asset('website/images/footer-logo.png') }}" class="img-fluid" alt="">
                        </figure>
                    </a>
