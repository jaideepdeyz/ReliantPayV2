<div class="container-fluid">
                    ...
                    <form wire:submit.prevent="registerclient">
                                    ...
                                    <div class="card-body">
                                        <h5 class="text-uppercase bg-light p-2 mt-0 mb-3">Step 1/5: Business Information</h5>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="business_address" name="business_address" placeholder="Enter business address" value ="{{ old('business_address') }}" wire:model="business_address">
                                        ...
                                        <h5 class="text-uppercase bg-light p-2 mt-0 mb-3">Step 2/5: Statutory Compliances</h5>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="form-check form-switch">
                                                    <input class="form-check-input" type="checkbox" id="flexSwitchCheckDefault" wire:model="business_PCI_DSS_compliance_status">
                                                    <label class="form-check-label" for="flexSwitchCheckDefault">PCI DSS Compliant</label>
                                                </div>

                                                
                                                
                                                <span class="text-danger"> @error('business_PCI_DSS_compliance_status') {{ $message}} @enderror </span>
                                            </div>

                                            <div class="mb-3">
                                                 <div class="form-check form-switch">
                                                    <input class="form-check-input" type="checkbox" id="flexSwitchCheckDefault" wire:model="business_HTTPS_compliance_status">
                                                    <label class="form-check-label" for="flexSwitchCheckDefault">HTTPS Compliant</label>
                                                </div>

                                                <span class="text-danger"> @error('business_HTTPS_compliance_status') {{ $message}} @enderror </span>
                                            </div>
