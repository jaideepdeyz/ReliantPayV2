    ...
    function s(t, e, a) {
        ...
        if (d) {
            ...
            d instanceof Element
                ? (r.appendChild(d),
                  (c = "#" + (d.id || "tippy-html-template")))
                : ((r.innerHTML = document.querySelector(d).innerHTML),
                  (c = d)),
        ...
        me = (function () {
            function t(e, a) {
                ...
                re(this, t),
                    ...
                    Object.keys(
                        se({}, t.Defaults.modifiers, o.modifiers)
                    ).forEach(function (e) {
        ...
        (me.Defaults = {
            ...
            modifiers: {
                ...
                arrow: {
                    ...
                    fn: function (t, e) {
                        ...
                        var o = t.placement.split("-")[0],
                            ...
                            h = H(i)[l];
                        n[f] - h < p[c] &&
                            (t.offsets.popper[c] -= p[c] - (n[f] - h)),
                            n[c] + h > p[f] &&
                                (t.offsets.popper[c] += n[c] + h - p[f]),
                ...
                hide: {
                    ...
                    fn: function (t) {
                        if (
                            !it(t.instance.modifiers, "hide", "preventOverflow")
                        )
                            return t;
                        ...
                        value: function () {
                            ...
                            if (!this.state.destroyed) {
                                ...
                                [
                                    ...
                                    this._(be).mutationObservers.forEach(
                                        function (t) {
                                            t.disconnect();
                                        }
                                    ),
